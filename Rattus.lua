	...
	if enemytorso ~= nil then
		...
		if (hroot.Position - enemytorso.Position).Magnitude < 100 then
			...
			if spikeupd == 100 then
				...
				local rayc = workspace:Raycast(enemytorso.Position+(enemytorso.Parent:FindFirstChildOfClass("Humanoid").MoveDirection*7*(enemytorso.Parent:FindFirstChildOfClass("Humanoid").WalkSpeed/16)),Vector3.new(0,-200,0),params)
				if rayc then
